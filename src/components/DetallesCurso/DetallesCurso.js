  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-r from-[#1E3A8A] to-[#4CAF50] p-6 md:p-12">
      ...
      <div className="mt-6 text-center">
        ...
        <p className="text-lg md:text-xl text-white mt-4">{curso.descripcion}</p>
      </div>

      {/* Botón de comprar */}
      <div className="mt-6 text-center">
        <button className="px-6 py-3 bg-[#002855] text-white font-bold rounded-lg hover:bg-[#00A1E0] transition duration-300">
      ...
      {curso.video && (
        <div className="mt-12">
          <h2 className="text-2xl font-bold text-center text-[#003366] mb-4">Video introductorio</h2>
          <video
            src={curso.video}
            controls
      ...
      {curso.etiquetas && (
        <div className="mt-12">
          <h2 className="text-2xl font-bold text-center text-[#003366]">Contenido del Curso</h2>
      ...
      {/* Planes de pago */}
      <div className="mt-16">
        <h2 className="text-2xl font-bold text-center text-[#003366] mb-6">Planes de Pago</h2>
