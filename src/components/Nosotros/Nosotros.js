  ...
  return (
    <div className="bg-gradient-to-r from-[#002855] to-[#00A1E0] p-6 md:p-12 text-[#002855]">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-12">
        <div className="bg-[#002855] text-white p-6 md:p-8 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300">
      ...
      <section className="text-center">
        ...
        <div className="grid grid-cols-1 gap-10">
          {[{ image: equipo1, name: "Dr. Francisco Farnum", title: "Investigador Principal", email: "ffarnum@redipai.org", phone: "+507 6675-1782", orcid: "https://orcid.org/0000-0002-5879-2296" },
            ...
            { image: equipo4, name: "Ing. Israel Samuels", title: "Desarrollador Full Stack", email: "soporte@portaldecartelescientificos.org", phone: "+507 6549-8362", orcid: "https://orcid.org/0009-0007-1212-718X" },
            ...
            <div key={member.name} className="bg-[#002855] text-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col md:flex-row items-center md:items-start">
              <img 
                src={member.image} 
                alt={member.name} 
                className="w-32 h-32 md:w-48 md:h-48 object-cover rounded-full mb-4 md:mb-0 md:mr-6 transform hover:scale-105 transition-transform duration-300" 
              />
              <div className="text-center md:text-left">
                ...
                <a href={member.orcid} className="hover:underline mt-1">ORCID</a>
              </div>
            </div>
          ))}
        </div>
