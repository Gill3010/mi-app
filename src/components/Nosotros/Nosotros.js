          ...
          {[
            {
              ...
              email: "gerencia@portaldecartelescientificos.org",
              phone: "+507 6675-1782",
            ...
            },
            {
              ...
              email: "administracionypagos@portaldecartelescientificos.org",
              phone: "+507 6645-7685",
              orcid: "https://orcid.org/0009-0009-8858-0954",
            },
            {
              image: equipo3,
              name: "Magister Mónica Contreras",
              title: "Gerente Académica",
              email: "gerenteacademico@portaldecartelescientificos.org",
              phone: "+507 6773-4854",
            ...
            },
            {
              image: equipo6,
              name: "Dr. Sósimo Poma",
              title: "Evaluador Académico",
              email: "evaluadoracademico@portaldecartelescientificos.org",
            ...
            {
              image: equipo8,
              name: "Dra. Sandra Bedoya Marulanda",
              title: "Alianza Estratégica Universitaria",
              email: "mercadeoyventas@portaldecartelescientificos.org",
              phone: "+57 3168316782",
              orcid: "0009-0005-7307-8233",
            },
          ].map((member) => (
            <div
              key={member.name}
            ...
            >
              ...
              <div className="text-center sm:text-left">
                ...
                <a
                  href={member.orcid}
                  className="hover:underline mt-1 text-[#4A90E2] transition-colors duration-300 hover:text-blue-300 flex items-center"
                  target="_blank"
