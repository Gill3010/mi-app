              ...
              <div className="md:w-2/3 p-4 flex flex-col justify-between">
                <div className="text-blue-900 space-y-2 sm:space-y-3">
                  ...
                  <p><strong>Fecha de Publicación:</strong> 
                    {galeria.fechaPublicacion && galeria.fechaPublicacion.seconds 
                      ? new Date(galeria.fechaPublicacion.seconds * 1000).toLocaleDateString() 
                      : "Fecha no disponible"}
                  </p>
                  {galeria.resumen && (
                    <p><strong>Resumen:</strong> <a href={galeria.resumen} target="_blank" rel="noopener noreferrer" className="text-blue-800 underline">Ver documento</a></p>
                  )}
                  {galeria.audio && (
