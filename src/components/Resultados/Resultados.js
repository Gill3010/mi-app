        ...
        {results && Array.isArray(results) && results.length > 0 ? (
          <ul className="space-y-4">
            {results.map((item) => (
              <li 
                key={item.id} 
                className="p-4 border border-gray-200 rounded-lg hover:shadow-lg cursor-pointer transition duration-300 ease-in-out hover:border-[#002855]" 
              ...
              >
                ...
                <p className="text-gray-500">Resumen: {item.resumen}</p>
