...
const Cursos = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-white p-6 md:p-12">
      <h1 className="text-3xl md:text-4xl font-extrabold mb-6 text-center text-transparent bg-clip-text bg-gradient-to-r from-[#1B5E20] to-[#FFC107] shadow-xl p-6 bg-white rounded-lg">
        Cursos
      </h1>
        ...
        {courses.map((course) => (
          ...
          >
            ...
            <div className="p-4">
              ...
              <p className="text-white mt-2 text-sm">{course.descripcion}</p>
