...
const ReferenciasBibliograficas = () => {
  return (
    <div className="bg-gradient-to-r from-green-400 via-blue-500 to-purple-600 p-8 text-white">
      <div className="bg-white p-6 rounded-lg shadow-lg max-w-4xl mx-auto">
        <h2 className="text-2xl font-bold text-gray-800 mb-4">Referencias Bibliográficas</h2>
