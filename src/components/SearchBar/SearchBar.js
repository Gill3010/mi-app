...
const SearchBar = () => {
  ...
  return (
    <div className="flex flex-col items-center mt-8 w-full max-w-lg mx-auto">
      <input
        className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-[#1B5E20] mb-4"
        type="text"
        value={query}
      ...
      />
      <button
        className="bg-gradient-to-r from-[#1B5E20] via-[#2E7D32] to-[#FFC107] hover:bg-[#2E7D32] text-white font-bold py-2 px-4 rounded-md transition duration-300 ease-in-out"
