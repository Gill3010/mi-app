  ...
  const courses = [
    {
      ...
      video: 'videos/programacion1.mp4',
      file: 'files/programacion1.pdf',
      audio: 'audio/programacion1.mp3',
      image: 'img/Programacion.jpg',
    },
    {
      id: 2,
      title: 'JavaScript Avanzado',
      description: 'Curso avanzado para desarrollar aplicaciones dinámicas.',
      video: 'videos/programacion2.mp4',
      file: 'files/programacion2.pdf',
      audio: 'audio/programacion2.mp3',
      image: 'img/Programacion.jpg',
    },
    {
      id: 3,
      title: 'Desarrollo Web Completo',
      description: 'Aprende a construir sitios web completos con herramientas modernas.',
      video: 'videos/programacion3.mp4',
      file: 'files/programacion3.pdf',
      audio: 'audio/programacion3.mp3',
      image: 'img/Programacion.jpg',
    },
    {
      id: 4,
      title: 'Desarrollo Backend',
      description: 'Especialización en servidores y bases de datos.',
      video: 'videos/programacion4.mp4',
      file: 'files/programacion4.pdf',
      audio: 'audio/programacion4.mp3',
      image: 'img/Programacion.jpg',
    },
    {
      id: 5,
      title: 'Desarrollo Frontend',
      description: 'Domina HTML, CSS, y JavaScript para interfaces modernas.',
      video: 'videos/programacion5.mp4',
      file: 'files/programacion5.pdf',
      audio: 'audio/programacion5.mp3',
      image: 'img/Programacion.jpg',
    },
  ];
    ...
    <div className="p-6 md:p-12 max-w-6xl mx-auto bg-gray-100">
      ...
      <div className="text-center p-4 bg-white rounded-lg shadow-md mb-8">
        <p className="text-lg md:text-xl font-medium text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-teal-400">
          Descubre nuestros cursos especializados en programación, ideales para desarrollar tus habilidades técnicas.
        </p>
      </div>
