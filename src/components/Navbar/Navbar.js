          ...
          >
            <li>
              <a
                href="#asesorias"
                className="text-white hover:bg-[#005073] block px-4 py-2"
                onClick={() => toggleNestedSubmenu("asesorias")}
              >
                Asesorías
              </a>
              <ul
                className={`${
                  openNestedSubmenu === "asesorias" ? "block" : "hidden"
                } bg-gray-700 p-2 space-y-1 ml-4`}
              >
                <li>
                  <NavLink
                    to="/asesorias/planeacion"
